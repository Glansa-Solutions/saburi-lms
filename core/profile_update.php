...
include('db_config.php');
    ...
    if (isset($_POST['update_company_register'])) {
        ...
        // Update the database
        $update_query = "UPDATE company SET companyName='$fullName', DOB='$DOB', address='$address', country='$country_id', state='$state_id', pincode='$pincode', gender='$gender', phoneNumber='$phoneNumber', email='$email', idProof='$idProof', idProofDetails='$idProofDetails' WHERE id='$studentId'";
