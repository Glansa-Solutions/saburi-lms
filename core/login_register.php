...
if (isset($_POST['registerStudent'])) {
    ...
    if ($insertQuery) {
        ...
        try {
                ...
                <div class='container'>
                    ...
                    <div class='content'>
                        ...
                        <ul>
                            ...
                            <li><strong>Password:</strong> $activationcode</li>
                        </ul>
                        ...
                        <ol>
                        <li>Click on the following link: <a href='$mainlink"."account?role=$role&id=$insertedId'>Login Here</a></li>
            ...
            $mail->send();
            header("location: ../message?role=$role&id=$insertedId");
