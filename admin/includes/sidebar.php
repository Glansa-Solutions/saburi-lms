...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Typography</a></li> -->
                    ...
                    <li class="nav-item"> <a class="nav-link" href="<?= $mainlink ?>admin/about">About</a></li>
                    <li class="nav-item"> <a class="nav-link" href="<?= $mainlink ?>admin/contact">Contact Details</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="<?= $mainlink ?>admin/privacy">Privacy policy</a></li>
                    <li class="nav-item"> <a class="nav-link" href="<?= $mainlink ?>admin/terms">Terms
                            & Conditions</a></li>
                    <li class="nav-item"> <a class="nav-link" href="<?= $mainlink ?>admin/development">Sustainable
                            Development</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?= $mainlink; ?>admin/topic">Topics</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link"
                            href="<?= $mainlink ?>admin/manageStudentSubscription">Student
                            Subscriptions</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?= $mainlink ?>admin/manageBulkRegistration">Bulk
                            registrations</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?= $mainlink ?>admin/managePayments">Payments</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?= $mainlink; ?>admin/manageUser">Users</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="charts">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="<?= $mainlink; ?>admin/userContacReports">User
                            Contact List
                        </a></li>
                </ul>
            </div>
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?= $mainlink; ?>admin/blog">
                <i class="menu-icon mdi mdi-file-document"></i>
                <span class="menu-title">Blog</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?= $mainlink; ?>admin/freeResources">
                <i class="menu-icon mdi mdi-file-document"></i>
                <span class="menu-title">Free resources</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?= $mainlink; ?>admin/affiliate">
                <i class="menu-icon mdi mdi-file-document"></i>
                <span class="menu-title">Affiliate</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?= $mainlink; ?>admin/career">
                <i class="menu-icon mdi mdi-file-document"></i>
                <span class="menu-title">Career</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?= $mainlink; ?>admin/companyUsers">
                <i class="menu-icon mdi mdi-file-document"></i>
                <span class="menu-title">Company Users</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?= $mainlink; ?>admin/commentsBlog">
                <i class="menu-icon mdi mdi-file-document"></i>
                <span class="menu-title">Blog Comments</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?= $mainlink; ?>admin/commentsCourse">
                <i class="menu-icon mdi mdi-file-document"></i>
                <span class="menu-title">Course Comments</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?= $mainlink; ?>admin/corpogov">
                <i class="menu-icon mdi mdi-file-document"></i>
